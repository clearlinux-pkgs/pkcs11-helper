...
Source0  : https://github.com/OpenSC/pkcs11-helper/releases/download/pkcs11-helper-1.27/pkcs11-helper-1.27.0.tar.bz2
...
Patch2: 0002-nss-use-nss-pkcs11.h.patch
...
%prep
%setup -q -n pkcs11-helper-1.27.0
cd %{_builddir}/pkcs11-helper-1.27.0
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1634321048
...
cp %{_builddir}/pkcs11-helper-1.27.0/COPYING %{buildroot}/usr/share/package-licenses/pkcs11-helper/cd2cbb12b3b9e8d38503591ede835d70de9a3b08
cp %{_builddir}/pkcs11-helper-1.27.0/COPYING.BSD %{buildroot}/usr/share/package-licenses/pkcs11-helper/43ded7db4128951bf7f85fa4b56da2fe822f8eb7
cp %{_builddir}/pkcs11-helper-1.27.0/COPYING.GPL %{buildroot}/usr/share/package-licenses/pkcs11-helper/bd040aef1740f62ce7275c20b40e0d87811d80f6
cp %{_builddir}/pkcs11-helper-1.27.0/distro/debian/copyright %{buildroot}/usr/share/package-licenses/pkcs11-helper/370f4923a0ff14d216752b3699c5ccd2cd4a34b1
%make_install
